class TableauTiled extends Tableau{
    ...
    preload() {
      ...
      // ------pour TILED-------------
      // nos images
      this.load.image('tiles', 'assets/toto/Tuiles/AssetB.png');
      this.load.image('tiles', 'assets/toto/Tuiles/AssetF.png');
      this.load.image('tiles', 'assets/toto/Tuiles/Devant.png');
      this.load.image('tiles', 'assets/toto/Tuiles/Eau.png');
      this.load.image('tiles', 'assets/toto/Tuiles/Fond.png');
      this.load.image('tiles', 'assets/toto/Tuiles/Indication.png');
      this.load.image('tiles', 'assets/toto/Tuiles/Solide');
  ...
  create() {
    ...
    let ici=this;
          ...
          this.tileset = this.map.addTilesetImage('AssetB', 'tiles');
          this.tileset = this.map.addTilesetImage('AssetF', 'tiles');
          this.tileset = this.map.addTilesetImage('Devant', 'tiles');
          this.tileset = this.map.addTilesetImage('Eau', 'tiles');
          this.tileset = this.map.addTilesetImage('Fond', 'tiles');
          this.tileset = this.map.addTilesetImage('Indication', 'tiles');
          ...
          this.AssetF = this.map.createLayer('AssetF', this.tileset, 0, 0);
          this.AssetB = this.map.createLayer('AssetB', this.tileset, 0, 0);
          this.Fond = this.map.createLayer('Fond', this.tileset, 0, 0);
          this.Indication = this.map.createLayer('Indication', this.tileset, 0, 0);
